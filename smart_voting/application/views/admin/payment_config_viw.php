            ...
            <div class="col-sm-12">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" name="myForm" action="<?=base_url();?>admin_dashboard/save_new_payment" method="post" onsubmit="return validateForm()">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Last Updated Amount (Rs .<?=$currentamount;?>)<font color="red">*</font></label>
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Please Enter New Amount" required="required" name="newamount" id="newamount" value="">
                    </div>

    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <form action="<?=base_url();?>reports/yearly_income_report" method="post">
                    <div class="row">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Yearly Income Report (<?=$years;?>)</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover" id="example">
                      ...
                      <tbody>
                        ...
                        ?>
                        <tr>
                          <td><?php echo $ols->org_name;?> [<?php echo $ols->org_code;?>]</td>
                          <td><?php echo $ols->amount;?></td>

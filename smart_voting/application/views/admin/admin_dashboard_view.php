...
<body>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="statistics-details d-flex align-items-center justify-content-between">
                          <div>
                            <p class="statistics-title">All Organizations</p>
                            <h3 class="rate-percentage"><?php echo $act_org_count+$inact_org_count;?></h3>
                            
                          </div>
                          <div>
                            <p class="statistics-title">All Admins</p>
                            <h3 class="rate-percentage"><?php echo $act_admin_count+$inactive_admin_count;?></h3>
                                ...
                                <div class="row">
                                  <div class="col-lg-12">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                      <h4 class="card-title card-title-dash">Active / Inactive Organizations</h4>
                                    </div>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-lg-12">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                      <h4 class="card-title card-title-dash">Active / Inactive Admins</h4>
                                    </div>
  ...
  $(function() {
    ...
    if ($("#doughnutChart1").length) {
      ...
      var act_admin_count = "<?php echo $act_admin_count;?>";
      var inactive_admin_count = "<?php echo $inactive_admin_count;?>";
     
      var doughnutPieData = {
        datasets: [{
          data: [act_admin_count, inactive_admin_count],
          backgroundColor: [
            "#1F3BB3",
            "#FDD0C7",
      ...
      document.getElementById('doughnut-chart-legend1').innerHTML = doughnutChart.generateLegend();
    }

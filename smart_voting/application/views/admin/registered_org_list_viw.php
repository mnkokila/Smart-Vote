    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <form action="<?=base_url();?>reports/registered_org_list" method="post">
                    <div class="row">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Registered Organizations List (<?=$years;?>)</h4>
                    ...
                    <table class="table table-hover" id="example">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $ols->org_code;?></td>
                          <td><?php
                             if($ols->active_stts==1){
                             echo "Active";
                           }else{
                           echo "Inactive";
                         }

    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <form action="<?=base_url();?>reports/memberlist" method="post">
                    <div class="row">
                     <div class="col-md-2">Enter Year</div> 
                    <div class="col-md-2">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Registered member List (<?=$years;?>)</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover" id="example">
                      ...
                      <tbody>
                        ...
                        //print_r(memberlist);
                        if($memberlist){
                         foreach($memberlist as $ols){

                        ?>
                        <tr>
                          <td><?php echo $ols->user_full_name;?></td>
                          <td><?php echo $ols->admin_nic;?></td>
                          <td><?php

...
<body>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="statistics-details d-flex align-items-center justify-content-between">
                          <div>
                            <p class="statistics-title">Active Members</p>
                            <h3 class="rate-percentage"><?=$act_mem;?></h3>
                            
                          </div>
                          <div>
                            <p class="statistics-title">Active Elections</p>
                            <h3 class="rate-percentage"><?=$act_elec;?></h3>
                                ...
                                <div class="row">
                                  <div class="col-lg-12">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                      <h4 class="card-title card-title-dash">Active / Inactive Members</h4>
                                    </div>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-lg-12">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                      <h4 class="card-title card-title-dash">Active / Inactive Elections</h4>
                                    </div>
                                    <canvas class="my-auto" id="doughnutChart1" height="200"></canvas>
                                    <div id="doughnut-chart-legend1" class="mt-5 text-center"></div>
                                  </div>
                                </div>
                              </div>
                            </div>
  ...
  $(function() {
    ...
    if ($("#doughnutChart").length) {
      ...
      var act_mem = "<?php echo $act_mem;?>";
      var inact_mem = "<?php echo $inact_mem;?>";
     
      var doughnutPieData = {
        datasets: [{
          data: [act_mem, inact_mem],
          backgroundColor: [
            "#1F3BB3",
            "#FDD0C7",
    ...
    if ($("#doughnutChart1").length) {
      ...
      var act_org_count = "<?php echo $act_elec;?>";
      var inact_org_count = "<?php echo $inact_elec;?>";
      //alert(act_org_count)
      var doughnutPieData = {
        datasets: [{
          data: [act_org_count, inact_org_count],
          backgroundColor: [
            "#1F3BB3",
            "#FDD0C7",
      ...
      document.getElementById('doughnut-chart-legend1').innerHTML = doughnutChart1.generateLegend();
    }

        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Edit Assigned Candidates</h4>
                  
                    <form action="<?=base_url();?>elections/edit_assign_candidate" method="post">
                    <input type="hidden" name="orgid" value="<?=$this->session->userdata('orgid');?>">
                    <input type="hidden" name="electionids" value="<?php echo $election_id;?>">
                    <input type="hidden" name="positionids" value="<?php echo $positionid;?>">
                    
                    <div class="form-group">
                      <label for="exampleInputUsername1">Election</label>
                      <select class="form-control" id="electionid" name="electionid" required="required" disabled="disabled">
                        ...
                        ?>
                        <option value="<?php echo $el->election_main_id;?>" <?php if($election_id==$el->election_main_id){ echo 'selected'; }?>><?php echo $el->election_name;?></option>
                        <?php
                           }
                          }
                        }
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="" id="" class="form-control" value="<?=$positionname;?>" readonly>
                    </div>
                    ...
                    <select name="member[]" id="member"  class="form-control select2 chosen-select" multiple required="required">
                      ...
                      if($memberlist){
                        ...
                        if(in_array($ml->user_id,$candidatelist)){
                      ?>

                      <option value="<?php echo $ml->user_id;?>" selected><?php echo $ml->user_full_name;?>[<?php echo $ml->admin_nic;?>]</option>
                      <?php
                         }else{
                       ?>
                       <option value="<?php echo $ml->user_id;?>"><?php echo $ml->user_full_name;?>[<?php echo $ml->admin_nic;?>]</option>
                       <?php  
                       }
                        }
                      }

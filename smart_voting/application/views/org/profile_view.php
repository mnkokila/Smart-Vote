              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="hidden" id="mycurrentpw" value="<?php echo $mydata->u_password;?>">
                  ...
                  <form class="forms-sample" action="<?=base_url();?>org_admin_dashboard/update_admin_pw" method="post" id="newpasswordform">

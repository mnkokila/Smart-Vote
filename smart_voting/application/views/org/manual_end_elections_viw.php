        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Manual Election End List</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        ?>
                        <tr>
                          <td><?php echo $el->elect_year." - ".$el->elect_month;?></td>
                          ...
                          <td>
                            <a href="<?php echo base_url();?>elections/manual_end_election_process/<?php echo $el->election_main_id;?>" class="btn btn-sm btn-info">Mannual End</a>
